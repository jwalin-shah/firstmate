...
| `fm-proof.sh` | Development-contract proof ledger CLI (docs/proof-enforcement.md) |
| `fm-proof-pretool-check.sh` | PreToolUse transport for proof-enforcement write gating (docs/proof-enforcement.md) |
