...
Pick tmux unless you have a specific reason to try an experimental backend (herdr) - it is the fully verified reference path for secondmate homes.
...
None specific to tmux - it is the fully verified reference backend.
